// Takes the values of multiple fields and creates an object from them
import {
...
const fn = (rect, DCAPI) => {
  ...
  table.appendChild(
    createPropertyEditor("Table ID", "tableId", fileds, generateCode)
  );
...
export const gridNewItemEditor = {
  name: "field-itemizer-action",
  displayname: "Field itemizer",
  fn: fn
};
